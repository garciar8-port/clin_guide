...
resource "aws_security_group" "ecs" {
  ...
  description = "Allow traffic from ALB and between ECS tasks"
  vpc_id      = aws_vpc.main.id
...
# Allow ECS tasks to talk to each other (service discovery)
resource "aws_security_group_rule" "ecs_internal" {
  ...
  description              = "API from other ECS tasks (service discovery)"
}
